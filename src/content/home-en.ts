...
export const en: HomeStrings = {
  ...
  strava: {
    ...
    blurb:
      'A live look at the last four weeks of running, riding, and everything in between, straight from Strava.',
    totalsCaption: 'last 4 weeks · live from strava',
    statDistance: 'kilometers',
    statTime: 'hours moving',
