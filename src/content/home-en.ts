...
export const en: HomeStrings = {
  ...
  strava: {
    ...
    blurb:
      'A live look at the last twelve weeks of running, riding, and everything in between, mapped straight from Strava.',
    heroCaption: 'last 12 weeks · live from strava',
    statKm: 'kilometers',
    ...
    insightLongestLabel: 'Longest effort',
    insightBiggestLabel: 'Biggest week',
    insightClimbedLabel: 'Climbed',
    insightBusiestLabel: 'Most active',
