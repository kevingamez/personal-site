...
export const enRoles: HomeRole[] = [
  ...
  },
  {
    ...
    ledger: [
      { label: 'Response times', value: '10% faster' },
      { label: 'Marketplace sides', value: 'Both' },
      { label: 'Shipped on', value: 'iOS, Android, web' },
  ...
  },
  {
    ...
    ledger: [
      ...
      { label: 'Released to', value: 'Every client server' },
      { label: 'Reporting', value: 'Scheduled queries' },
      { label: 'Replaced', value: 'Hand-built reports' },
    ],
    stackLabel: 'Built with',
  ...
  },
  {
    ...
    ledger: [
      ...
      { label: 'Dedication', value: 'Part-time' },
      { label: 'Department', value: 'Systems and Computing' },
      { label: 'Subject', value: 'Data at scale' },
    ],
  ...
  },
  {
    ...
    ledger: [
      { label: 'Mathematics', value: 'Dec 2022' },
      { label: 'Management', value: 'Dec 2022' },
      { label: 'Taken', value: 'Inside the B.Sc.' },
      { label: 'Ahead of the degree', value: '12 months' },
    ],
    stackLabel: 'Areas',
  ...
  },
  {
    ...
    ledger: [
      ...
      { label: 'Thesis accuracy', value: '98.4%' },
      { label: 'Thesis F1', value: '0.991' },
    ],
