...
export const esRoles: HomeRole[] = [
  ...
  },
  {
    ...
    ledger: [
      { label: 'Tiempos de respuesta', value: '10% más rápidos' },
      { label: 'Lados del marketplace', value: 'Ambos' },
      { label: 'Lanzado en', value: 'iOS, Android, web' },
  ...
  },
  {
    ...
    ledger: [
      ...
      { label: 'Publicaba en', value: 'Cada servidor cliente' },
      { label: 'Consultas', value: 'Programadas' },
      { label: 'Reemplazó', value: 'Reportes hechos a mano' },
    ],
    stackLabel: 'Construido con',
  ...
  },
  {
    ...
    ledger: [
      ...
      { label: 'Dedicación', value: 'Part-time' },
      { label: 'Departamento', value: 'Sistemas y Computación' },
      { label: 'Tema', value: 'Datos a escala' },
    ],
    stackLabel: 'Cursos',
    stack: [
  ...
  },
  {
    ...
    ledger: [
      { label: 'Matemáticas', value: 'Dic 2022' },
      { label: 'Administración', value: 'Dic 2022' },
      { label: 'Cursadas', value: 'Dentro del pregrado' },
      { label: 'Antes del título', value: '12 meses' },
    ],
    stackLabel: 'Áreas',
  ...
  },
  {
    ...
    ledger: [
      ...
      { label: 'Exactitud de la tesis', value: '98,4%' },
      { label: 'F1 de la tesis', value: '0,991' },
    ],
