...
export const es: HomeStrings = {
  ...
  strava: {
    ...
    blurb:
      'Una mirada en vivo a las últimas doce semanas corriendo, en bici y todo lo demás, directo de Strava.',
    heroCaption: 'últimas 12 semanas · en vivo desde strava',
    statKm: 'kilómetros',
    ...
    insightLongestLabel: 'Más largo',
    insightBiggestLabel: 'Mejor semana',
    insightClimbedLabel: 'Escalado',
    insightBusiestLabel: 'Día estrella',
