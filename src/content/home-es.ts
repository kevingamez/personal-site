...
export const es: HomeStrings = {
  ...
  strava: {
    ...
    blurb:
      'Una mirada en vivo a las últimas cuatro semanas corriendo, en bici y todo lo demás, directo de Strava.',
    totalsCaption: 'últimas 4 semanas · en vivo desde strava',
    statDistance: 'kilómetros',
    statTime: 'horas en movimiento',
