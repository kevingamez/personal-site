...
export const es: HomeStrings = {
  ...
  console: {
    secNum: '§08 · Consola',
    titleHtml: 'Pregúntale al sitio <i>lo que sea.</i>',
    blurb: 'Un pequeño playground de LLM. Conectado a mis textos, proyectos y al README público.',
    promptLabel: 'kevin@gamez · ~',
    streaming: 'en vivo',
    greeting: 'hola · pregúntame sobre mi trabajo, el stack o cualquier cosa del README.',
    placeholder: 'escribe una pregunta, enter para enviar…',
    suggest1: '¿qué hace enttor.ai?',
    suggest2: 'cuéntame del pipeline de outbound',
    suggest3: '¿por qué bilingüe?',
    suggest4: '¿cómo está construida la página /dev?',
