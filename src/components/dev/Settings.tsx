    ...
    <aside id="settings" className="settings-panel" hidden>
      ...
      <section className="st-block">
        ...
        <div className="st-themes" role="radiogroup" aria-label="Theme">
          ...
          >
            <div
              className="st-swatch"
              style={{ background: 'linear-gradient(135deg,#faf7f0 0%,#ebe3d4 50%,#d96944 100%)' }}
            ></div>
            <span>Cream</span>
          </button>
          <button
          ...
          >
            <div
              className="st-swatch"
              style={{ background: 'linear-gradient(135deg,#0d0d14 0%,#1f1d2a 60%,#6b8eff 100%)' }}
            ></div>
            <span>Midnight</span>
          </button>
          <button
          ...
          >
            <div
              className="st-swatch"
              style={{ background: 'linear-gradient(135deg,#f3e4cb 0%,#c2a085 60%,#7a4a2a 100%)' }}
            ></div>
            <span>Sepia</span>
          </button>
          <button
          ...
          >
            <div
              className="st-swatch"
              style={{ background: 'linear-gradient(135deg,#fff4d9 0%,#ffb066 60%,#d9483a 100%)' }}
            ></div>
            <span>Solar</span>
          </button>
        </div>
      ...
      <section className="st-block">
        ...
        <div className="st-row">
          ...
          <output htmlFor="st-fontsize" id="st-fontsize-out">
            13px
          </output>
        </div>
      </section>
      ...
      <section className="st-block">
        ...
        <div className="st-segment" role="radiogroup" aria-label="Cursor">
          <button className="st-seg on" data-cursor="block" role="radio" aria-checked="true">
            Block
          </button>
          <button className="st-seg" data-cursor="bar" role="radio" aria-checked="false">
            Bar
          </button>
          <button className="st-seg" data-cursor="underline" role="radio" aria-checked="false">
            Underline
          </button>
        </div>
      </section>
      ...
      <section className="st-block">
        ...
        <label className="st-switch">
          ...
          <span className="st-switch-track">
            <span className="st-switch-thumb"></span>
          </span>
