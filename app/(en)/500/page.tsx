    ...
    <div className="err500">
      <div className="wrap">
        ...
        <div className="ctas">
          ...
          <button className="btn btn-ghost" type="button" id="refresh-btn">↻ Refresh</button>
          <a className="btn btn-ghost" href="/dev/">Open dev mode</a>
        </div>

        <div className="console" role="presentation">
          <div className="ln">
            <span className="nm">1</span><span><span className="key">$</span> <span className="mute">curl -i kevingamez.co</span></span>
          </div>
          <div className="ln"><span className="nm">2</span><span className="err">HTTP/1.1 500 Internal Server Error</span></div>
          <div className="ln"><span className="nm">3</span><span className="mute">x-build: static · vercel</span></div>
        </div>
      </div>
