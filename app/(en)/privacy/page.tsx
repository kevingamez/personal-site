    ...
    <main className="privacy-page">
      <article className="wrap privacy-article">
        <header>
          ...
          <p className="lede">
            Plain-language list of every piece of data <a href="/">kevingamez.co</a> sees, why, and
            how to opt out. Last updated 2026-08.
          </p>
        </header>
        ...
        <ul>
          ...
          <li>
            Aggregate analytics - page views, sections viewed, device, country - never tied to you.
          </li>
          <li>No cookies, no session replays, no fingerprinting.</li>
          <li>
            The <code>/api/chat</code> Claude console keeps your IP only for daily rate limiting (20
            messages / IP / day) and forgets it within 24 hours.
          </li>
        ...
        <p>
          First-party, cookieless. Records page paths, custom event names (e.g.{' '}
          <code>section_view</code>, <code>cta_click</code>), Core Web Vitals (LCP, INP, CLS) and
        ...
        <p>
          ...
          edge for rate-limiting and discarded at the end of each day. Conversations are not stored
          on the server.
        </p>
        ...
        <ul>
          ...
          <li>
            ...
            <code>/#console</code>, nothing reaches Anthropic. Browsing the rest of the site doesn't
            trigger any LLM call.
          </li>
          <li>
            <strong>Questions.</strong> Email{' '}
            <a href="mailto:kevingamez.kg@gmail.com">kevingamez.kg@gmail.com</a> about anything on
            this page.
          </li>
        </ul>
